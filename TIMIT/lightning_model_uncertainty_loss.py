...
class LightningModel(pl.LightningModule):
    def __init__(self, HPARAMS):
        ...
        self.models = {
            ...
            'UpstreamTransformerLpcc2': UpstreamTransformerLpcc2,
            'UpstreamTransformerLpcc3': UpstreamTransformerLpcc3,
    ...
    def configure_optimizers(self):
        ...
        lpccs_list = ['model.conv_features.0.weight','model.conv_features.0.bias','model.conv_features.2.weight','model.conv_features.2.bias','model.conv_features.4.weight','model.conv_features.4.bias','model.conv_features.6.weight','model.conv_features.6.bias']
